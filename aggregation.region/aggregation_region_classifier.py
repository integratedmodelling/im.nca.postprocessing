...
temp_export_dir = "../aggregation.region.classified/tmp/vcs.aggregated.country/"

# Path to export the final dataset.
# export_path = "/home/ubuntu/vcs_wb/by_landcover/tmp/vcs-aggregated-country.csv"
export_path = "../aggregation.region.classified/vegetation.carbon.stock/vcs-aggregated-country-landcover.csv"
